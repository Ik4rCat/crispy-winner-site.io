...
```bash
git clone https://github.com/Ik4rCat/car-education-site.git
cd car-education-site
```
...
[Ik4rCat](https://github.com/Ik4rCat) - Начинающий разработчик игр и программного обеспечения из Санкт-Петербурга
